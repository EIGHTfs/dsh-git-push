...
> 依据 skill-repo-index：插件相关 skill 唯一位置 = 插件项目 skills/。requirements 门禁清单已内置为 lib/user-requirements.json。
...
- requirements.md → lib/user-requirements.json（EIGHTfs 7 条开发者要求，随插件分发）
