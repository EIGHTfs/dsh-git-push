...
|------|----------|--------|----------|-----------|
| dsh-git-rescue | `git@github.com:EIGHTfs/dsh-git-rescue.git` | 公开 | `git clone git@github.com:EIGHTfs/dsh-git-rescue.git` | dsh-git-rescue / dsh-deployment-overview / dsh-test-env / dsh-blue-green-deploy / dsh-clean-env |
| dsh-session-manager | `git@github.com:EIGHTfs/dsh-session-manager.git` | 公开 | `git clone git@github.com:EIGHTfs/dsh-session-manager.git` | session-workspace-groups / session-archive-restorable / session-delete-self / peak-hour-economy / peak-hour-pause / analyze-then-confirm / verify-before-diagnose |
...
| dsh-bili-publisher | `git@github.com:EIGHTfs/dsh-bili-publisher.git` | 公开 | `git clone git@github.com:EIGHTfs/dsh-bili-publisher.git` | — |
...
| dsh-image-preview | `git@github.com:EIGHTfs/dsh-image-preview.git` | 公开 | `git clone git@github.com:EIGHTfs/dsh-image-preview.git` | — |
| dsh-session-group | `git@github.com:EIGHTfs/dsh-session-group.git` | 公开 | `git clone git@github.com:EIGHTfs/dsh-session-group.git` | — |
| dsh-task-completion | `git@github.com:EIGHTfs/dsh-task-completion.git` | 公开 | `git clone git@github.com:EIGHTfs/dsh-task-completion.git` | — |
| dsh-test-env-entry | `git@github.com:EIGHTfs/dsh-test-env-entry.git` | 公开 | `git clone git@github.com:EIGHTfs/dsh-test-env-entry.git` | dsh-test-env |
| dsh-test-sync-plugin | `git@github.com:EIGHTfs/dsh-test-sync-plugin.git` | 公开 | `git clone git@github.com:EIGHTfs/dsh-test-sync-plugin.git` | dsh-test-env |
| ai-work-archive | `git@github.com:EIGHTfs/ai-work-archive.git` | 公开 | `git clone git@github.com:EIGHTfs/ai-work-archive.git` | — |
...
`dsh-ai-work-archive`、`dsh-header-layout`、`dsh-header-layout-extension`、`dsh-host-perf`、
`dsh-maid-whale-webUI-main`、`dsh-model-router-v2`、`dsh-shift-router-src`、`dsh-sm-test`、`dsh-whale-musume-main`、
`dsh-test-home`（测试实例数据目录）、`dsh-test-home-clean`、`DeepSeekHarness-NAS`（另有库）
