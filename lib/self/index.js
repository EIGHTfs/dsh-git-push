 ...
 */
export const VERSION = '1.8.3'; // 2026-09-23：tree-doc 审计漂移修复（生成物豁免 + missing 降 notice） // 2026-09-23：CLI tree-doc 子命令 + CLI/源码审计一致性测试 + 版本纪律修订（每次提交默认升第三位） // 单一事实源：package.json 由 scan-version 校验一致性
