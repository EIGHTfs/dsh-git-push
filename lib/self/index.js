...
// 2026-09-25 1.9.2：移除伪 peerDependencies（dsh-tools/schemastery 宿主条件提供）——修复市场软链安装误报缺依赖
// 2026-09-23 1.9.1：系统提示词注入配置化（config.json injectUsageText 覆盖）+ 浅包装 git 用法入注入文本
// 2026-09-23 1.9.0：浅包装 git（未知命令透传 + git 子命令 + 自动凭据）——major/minor 另行指定
