/**
 * dsh-git-push — git 自动提交推送插件 v1.1.0（内置代码审计门禁，源自 dsh-code-audit 验证）
 *
 ...
 *   L0 静态（零 token）：JS 语法 / JSON / YAML / 敏感信息硬编码 / 凭据入库 / 大文件 / debugger / console
      ...
      handler: async (req, res) => {
        try {
          ...
          if (p === '/api/git-push/status' && m === 'GET') {
            return respond(res, {
              ok: true, plugin: 'dsh-git-push', version: '1.1.0',
