...
export async function apply(ctx, config = {}) {
  ...
  //        A1) 插件功能说明书全文（v1.28.1，强制）——skills/dsh-git-push-functions.md，
  //            collectFunctionManual 动态读文件；与 dsh-session-conductor 的 task-completion-report 同通道。
