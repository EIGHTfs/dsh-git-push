...
import { scanRepos, commitAndPush, getDiff, scanSensitiveFiles, ensureSensitiveIgnored, genReadme, rebuildHistory, previewRebuildHistory, listVersionCommits, resolveGitToken, ensureRemoteRepo, loadUserRequirements, cloneViaApi } from './core.js';
...
export async function apply(ctx, config = {}) {
  ...
  async function auditRepoPath(repoPath, { forceLlm = false } = {}) {
    const result = auditRepo(repoPath, { blockOn, exemptRepos });
