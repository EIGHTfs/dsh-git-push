...
export { checkFuncLinesAst, checkFuncDensityAst, funcRangesAst, checkFileLines, countCommentLines, checkRepeatedStringsAst } from './size.js';
...
// 2026-09-17：I/O 风险分级（四级；scanIoRiskAst 供 checks 层精筛与 scan-file-io 复用）
export { scanIoRiskAst, summarizeIoRisk, rankIoFixList, RISK_BADGE, RISK_LABEL } from './io-risk.js';
