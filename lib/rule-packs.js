...
export const RULE_SLOTS = ['nodejs', 'frontend', 'comment', 'dsh', 'template', 'private'];
/** 默认加载顺序（侧边栏可改；后覆盖前） */
export const DEFAULT_RULE_ORDER = ['nodejs', 'frontend', 'comment', 'dsh']; // template 是空模板：不加载（用户自定义入口，侧边栏启用才入顺序）；dsh=v1.50.0 dsh 插件专属审计
