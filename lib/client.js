window.__ModuleLoader__.load({
  ...
  factory: require => {
          ...
          open
            ? jsx.jsxs('div', {
              ...
              children: [
                ...
                GitPushCheckFields(cardProps),
                GitPushIgnoreField(cardProps),
                GitPushRuleCards(cardProps),
                GitPushViewerButtons(cardProps),
    ...
    function apply(ctx) {
      ...
      // v1.46.0：设置侧边栏独立页（settings.section 槽）——此前只挂 settings.plugin.item，
      // 侧边栏从来没有本插件入口（对照 dsh-skill-scoreboard 的 section 挂法）；复用同一卡片组件，
      // 两处共享同一 controller / store，状态一致。
      function GitPushSectionPage() {
        ...
        return jsx.jsxs('div', {
          ...
          children: [
            ...
            jsx.jsx('ul', { style: { listStyle: 'none', margin: '0', padding: '0' }, children: jsx.jsx(GitPushCard, cardProps()) }),
          ],
        });
      }
