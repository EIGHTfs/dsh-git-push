...
export const FUNCTION_USAGE_HINT = [
  ...
  '· git_commit_push —— 一键提交并推送（先审计→再 commit→再 push）。参数：repo=仓库绝对路径、message=提交信息（必填）、audit、dryRun、push、force、ignorePatterns；调用前逐条核对开发者特殊要求，达标才传 requirementsConfirmed=true。',
