...
export { filterRulesByExt, filterRulesByPath, filterRulesByFileText } from './filter.js';
export { checkRegexRules, checkPathRegexRules, checkBlacklist } from './regex.js';
export {
  checkFuncLines, checkEmptyCatch, checkMinLength,
  checkComplexity, checkDepth, checkMaxLines, checkRepeated,
} from './structural.js';
// 2026-09-17：I/O 风险分级检查器（取代 checkSyncFsInFile）
export { checkIoRisk } from './io.js';
...
export { checkDataflow } from './dataflow.js';
