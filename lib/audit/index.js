...
import { runChecks, groupByKind, HINT_QUALITY, checkFolderRules, checkPrivateFiles, isRepoLevelSemanticRule } from './checks.js';
...
export function auditFile({ file, relPath, text, grouped }, opts = {}) {
  ...
  findings = findings.filter((f) => {
    ...
    if ((isSkillDoc || isRulesDoc) && !isCode && isCommentRule) return false;
