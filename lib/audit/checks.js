...
import { checkSyncFs, checkEmptyCatchAst, checkFuncLinesAst, checkNameLengthAst, checkComplexityAst, checkNestingDepthAst, checkFileLines, checkRepeatedStringsAst, checkMagicNumberSmartAst, makeCodeLineFilter, checkSmallFileReadAst, checkShortFunctionNameAst, checkCredentialRefAst, checkPlaceholderCredentialAst, isMeaningfulCredentialValue } from '../score/ast.js';
 ...
 */
function placeholderCredentialLines(text) {
  return checkPlaceholderCredentialAst(text);
}

function credentialValueLines(text) {
