...
/** 远端最近 3 次：Markdown 表格（用户原话：「回复用表格形式」）。 */
 ...
 * 用户原话：「调用插件功能时强制要求读取 dsh-git-push-User dsh-git-push 两仓的 skill」
...
/**
 * 规范化生成 README 骨架。
 *  - 模板：同级仓 dsh-git-push-User/readme-template.md（用户原话：「模板应该放在我 dsh-git-push-User」）
