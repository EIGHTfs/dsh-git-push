...
export const DEFAULT_CONFIG = {
  ...
  defaultScanRoot: '',       // 默认扫描根（账号卡片本地扫描 / git_scan 未指定路径时用；空=自动识别 DSH 家根）
  commitMessage: '',
};
...
export const SETTINGS_SCHEMA = [
  ...
  { key: 'defaultScanRoot', type: 'string', default: '', label: '默认扫描路径', hint: '账号卡片「本地」扫描与 git_scan 未指定路径时的默认根；空=自动识别 DSH 家根（DSH_HOME 上一级）。可直接填绝对路径，无需重启即时生效' },
